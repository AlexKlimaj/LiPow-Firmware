...
#define VOLTAGE_CONNECTED_THRESHOLD			(uint32_t)( 1.5 * BATTERY_ADC_MULTIPLIER )
#define CELL_DELTA_V_ENABLE_BALANCING		(uint32_t)( 0.02 * BATTERY_ADC_MULTIPLIER )
#define CELL_BALANCING_HYSTERESIS_V			(uint32_t)( 0.015 * BATTERY_ADC_MULTIPLIER )
...
#define CELL_OVER_VOLTAGE_DISABLE_CHARGING	(uint32_t)( 4.29 * BATTERY_ADC_MULTIPLIER )
