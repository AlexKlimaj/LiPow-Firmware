...
{
  return PortNum == 0 ? UCPD_INSTANCE0 : UCPD_INSTANCE1;
}
...
LL_DMA_InitTypeDef DMA_InitStruct;
  ...
  case 0 :
    ...
    LL_DMA_Init(UCPDDMA_INSTANCE0_DMA_RX, UCPDDMA_INSTANCE0_LL_CHANNEL_RX, &DMA_InitStruct);
    break;
  case 1 :
    /* Enable the clock */
    ...
    LL_DMA_Init(UCPDDMA_INSTANCE1_DMA_RX, UCPDDMA_INSTANCE1_LL_CHANNEL_RX, &DMA_InitStruct);
    break;
  }

  return PortNum == 0 ? UCPDDMA_INSTANCE0_CHANNEL_RX : UCPDDMA_INSTANCE1_CHANNEL_RX;
}
...
DMA_Channel_TypeDef *USBPD_HW_Init_DMATxInstance(uint8_t PortNum)
{
  ...
  case 0 :
    ...
    LL_DMA_Init(UCPDDMA_INSTANCE0_DMA_TX, UCPDDMA_INSTANCE0_LL_CHANNEL_TX, &DMA_InitStruct);
    break;
  case 1 :
    ...
    DMA_InitStruct.Priority = LL_DMA_PRIORITY_MEDIUM;
    LL_DMA_Init(UCPDDMA_INSTANCE1_DMA_TX, UCPDDMA_INSTANCE1_LL_CHANNEL_TX, &DMA_InitStruct);
    break;
  }

  return (PortNum == 0)? UCPDDMA_INSTANCE0_CHANNEL_TX : UCPDDMA_INSTANCE1_CHANNEL_TX;
}
...
uint32_t USBPD_HW_GetRpResistorValue(uint8_t Pornum)
{
